...
void ClassImpl::requestPresentation(VidRoot::VidWindows::VidWndInfo& info)
{
	...
	vkCmdClearColorImage(curr_frame->cmd, curr_frame->presentation_buffer, swp_barrier.newLayout, &clear_value, 1, &subresource_range);
	...
	const VkPipelineStageFlags dst_masks = VK_PIPELINE_STAGE_TRANSFER_BIT;
