#include "renderui_bitmapbox.hpp"
#include <format>

using ClassImpl = nxcraft::intern::subsystems::GPGPU_ProcessorStageResources_RenderUI_BitmapBox;

ClassImpl::GPGPU_ProcessorStageResources_RenderUI_BitmapBox(const GPGPU_Device_Vulkan::Commons& commons, const GPGPU_ProcessorStageResources_RenderUI_General& renderui_generals)
{
