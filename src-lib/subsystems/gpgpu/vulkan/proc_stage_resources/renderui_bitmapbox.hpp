...
namespace nxcraft::intern::subsystems
{
	...
	class GPGPU_ProcessorStageResources_RenderUI_BitmapBox : public GPGPU_ProcessorStageResources_Vulkan
	{
	protected:
	...
	public:
		const std::vector<ShaderInfo> shaders
		{
			ShaderInfo
			{
				...
				.file_name = "ui_bitmapbox.vert.spv"
			},
			ShaderInfo
			{
				.stage_flags = VK_SHADER_STAGE_FRAGMENT_BIT,
				.file_name = "ui_bitmapbox.frag.spv"
			}
		};
		...
		GPGPU_ProcessorStageResources_RenderUI_BitmapBox(const GPGPU_Device_Vulkan::Commons& commons, const GPGPU_ProcessorStageResources_RenderUI_General& renderui_generals);
		virtual ~GPGPU_ProcessorStageResources_RenderUI_BitmapBox() = default;
