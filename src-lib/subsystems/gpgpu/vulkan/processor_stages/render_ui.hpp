...
namespace nxcraft::intern::subsystems
{
	...
	private:
		...
		void renderLayer_BitmapBoxes(VidRoot::VidWindows::VidWndInfo& info, GPGPU_Device_Vulkan* commons, GPGPU_ProcessorStageResources_RenderUI_CullElementsTmp::UniformData_BitmapBoxes&& layer, GPGPU_ProcessorStageResources_RenderUI_CullElementsTmp::Info_BitmapBoxes&& layer_info);
